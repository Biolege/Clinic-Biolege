                  ...
                  child: ListView(
                    ...
                    children: [
                      ListTile(
                        ...
                        subtitle: model.selectedDoctor.specialization != null &&
                                model.selectedDoctor.specialization.length != 0
                            ? Text(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "Appointments",
                                  style:
                                      TextStyle(color: offWhite, fontSize: 20),
                                ),
                                SizedBox(
                                ...
                                return FadeInLTR(
                                  ...
                                  Card(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text(model
                                          .customersForSelectedDoctor[index]
                                          .name),
                                      subtitle: Text(model
                                          .customersForSelectedDoctor[index]
                                          .phoneNumber
